...
/* package Qigua-0.1.0.0 */
#ifndef VERSION_Qigua
#define VERSION_Qigua "0.1.0.0"
#endif /* VERSION_Qigua */
#ifndef MIN_VERSION_Qigua
#define MIN_VERSION_Qigua(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Qigua */
...
#define CURRENT_COMPONENT_ID "Qigua-0.1.0.0-inplace-Qigua"
